...
public class UserPanel extends JPanel implements ActionListener {
  ...
  public UserPanel(String user) {
    ...
    Date creationDate = new Date(this.user.getCreationTime());
    Date lastUpdateDate = new Date(this.user.getLastUpdateTime());
    userLabel = new JLabel("<html>"+user+"<br>Created: "+creationDate+"<br>Last Updated: "+lastUpdateDate+"</html>");
  ...
  public void refresh() {
    ...
    String oldTweets = tweetsText.getText();
    tweetsText.setText("");
    for (Tweet tweet: user.getTweets()) {
      tweetsText.append( tweet.getTweet() + "\n" );
    }
    if (!tweetsText.getText().equals(oldTweets))
    	user.updateTime();
    Date creationDate = new Date(this.user.getCreationTime());
    Date lastUpdateDate = new Date(this.user.getLastUpdateTime());
    userLabel.setText("<html>"+user.getID()+"<br>Created: "+creationDate+"<br>Last Updated: "+lastUpdateDate+"</html>");
  }
