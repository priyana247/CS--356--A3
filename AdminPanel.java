...
public class AdminPanel extends JPanel implements ActionListener {
  ...
  private AdminPanel() {
    ...
    verifyIDsButton.setActionCommand(verifyIDsButton.getText());
    verifyIDsButton.addActionListener(this);
    
    JButton findLastUpdatedButton = new JButton("Find Last Updated");
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (command.equals("Add New User")) {
      ...
      JOptionPane.showMessageDialog(null,
    ...
    } else if (command.equals("Verify IDs")) {
    	if (db.verifyIDs())
    		JOptionPane.showMessageDialog(null,
                						"All IDs are valid." );
    	else
    		JOptionPane.showMessageDialog(null,
                    "Invalid IDs have been found.",
                    "Error",
                    JOptionPane.ERROR_MESSAGE);
    } else if (command.equals("Find Last Updated")) {
    	User lastUpdatedUser = db.findLastUpdatedUser();
    	if (lastUpdatedUser == null)
    		...
    		JOptionPane.showMessageDialog(null,
					"Last updated user is " + lastUpdatedUser.getID() + "." );
    }
    db.refresh();
  }
